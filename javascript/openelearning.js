...
h += ' id="collide' + obj.id + '" class="collide' + obj.id + '" ';
h += ' src="' + obj.text + '" ';
h += ' />';
}
...
h += ' id="zoneaction' + obj.id + '" class="bloc' + obj.id + ' zoneaction' + obj.id + '" ';
h += ' src="' + obj.text + '" ';
h += ' />';
h += '<a ';
if(istablet()){
h += ' href="javascript:return false" ';
}else{
h += ' href="#" ';
}
h += ' id="bloc' + obj.id + '" class="haveflou unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h += ' style="z-index:4;background-image:url(\'fx/transparent.png\');cursor:pointer;" ';
h += ' ></a>';
}
...
var Ecran=document.getElementById("main");if(haveHero){
...
h=h + "<param name=\"filename\" value='" + u1 + "'>";
}else if(u2!=''){
h=h + "<param name=\"filename\" value='" + u2 + "'>";
}else if(u3!=''){
h=h + "<param name=\"filename\" value='" + u3 + "'>";
}
h=h + "<param name=\"autoplay\" value=\"true\">";
h=h + "<param name=\"autoStart\" value=\"1\">";
if(loop==1){
h=h + "<param name='loop' value='true' />";
}
h=h + "</object> ";
...
var h='<object type="application/x-shockwave-flash" data="images/player_mp3_mini.swf" width="2" height="2">';h=h + '<param name="movie" value="images/player_mp3_mini.swf" />';
h=h + '<param name="bgcolor" value="#000000" />';
h=h + '<param name="FlashVars" value="mp3=' + url + '&amp;autoplay=1" />';
h=h + '</object>';
document.getElementById("dummyspan").innerHTML=h;
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg1" class="larg1 large" ';
h=h + ' src="' + img1 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg2" class="larg2 large" ';
h=h + ' src="' + img2 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg3" class="larg3 large" ';
h=h + ' src="' + img3 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg4" class="larg4 large" ';
h=h + ' src="' + img4 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg5" class="larg5 large" ';
h=h + ' src="' + img5 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg6" class="larg6 large" ';
h=h + ' src="' + img6 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg7" class="larg7 large" ';
h=h + ' src="' + img7 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var h='<img style="display:none;z-index:0;position:absolute;" ';h=h + ' id="larg8" class="larg8 large" ';
h=h + ' src="' + img8 + '" ';
h=h + ' />';
$("body").append(h);
}else{
...
var Timgbloc=$(simgbloc);Timgbloc.css("left",(e_x + 1 ) + "px");
}
}
if(obj.type=='infosbulle'){
...
inn=inn + '<a class="buttonDialogDownYes" href="javascript:window.open(\'data/' + file + '\');closeYNDown();" >Oui</a></p>';
if(!gebi("dialogDown")){
...
h += ' >';
h += '<tr>';
h += '<td id="innerbloc' + obj.id + '" style="' + alignByObj(obj) + cssPlus + obj.cssadd + '" class="unselectable ' +  obj.idscript + 'inner" unselectable="on" >';
var contentAffiche=appliqueVarsInTxt(obj.text);if(obj.align=='Fit'){
h=h + contentAffiche;
}else{
h=h + contentAffiche;
}
...
h += ' >';
var boit=obj.boite.replace("box","");h=h + '<div id="roundblue' + obj.id + '" class="' + boit + '" >';
...
h += 'class="LargegrayPanel" >';
h += '<a onClick="actPbshow(' + obj.id + ');" id="LargegrayPanelInner' + obj.id + '" class="LargegrayPanelInner" style="color:' + color + ';" >';
h += obj.text + '<span style="font-family:arial;" >&nbsp;&#9207;</arial>';
h += '</a>';
h += '<a onClick="actPbshow(' + obj.id + ');" id="LargegrayPanelBottom' + obj.id + '" style="display:none;" class="LargegrayPanelBottom" ></a>';
h += '<div id="LargegrayPanelText' + obj.id + '" style="display:none;" ';
...
h=h + '<div id="PanelCenterLink' + obj.id + '" class="PanelCenterLink" ></div>';
}else{
h=h + '<div id="PanelCenterLink' + obj.id + '" class="PanelCenterLink90" ></div>';
}
}else{
if(obj.getY()>largEcranHeight-320){
h=h + '<div id="PanelCenterLink' + obj.id + '" class="PanelCenterLink90" ></div>';
...
var obj=CObjets[i];var ctrOb=$("#LargegrayPanel" + i);
...
var mr=ctrOb.css('marginLeft');var obj=CObjets[i];if(obj.contenu5==""){
obj.contenu5=400;
}
...
var ctrOb=$("#LargePanelSide" + i + ",#LargePanelSideInner" + i);
var mr=ctrOb.css('marginRight');var obj=CObjets[i];if(obj.contenu5==""){
obj.contenu5=400;
}
var pw=parseInt(obj.contenu5);if(pw>parseInt(largEcranWidth*zoom)){
pw=parseInt(largEcranWidth*zoom);
...
var obj=CObjets[i];$(".PanelCenterLink,.PanelCenterLink90,.PanelCenterInner").css("display",'none');
...
h=h + '<video id="video' + ident +'" class="video-ludivideo video-ludivideo' + obj.id + '" controls preload="auto" ';
if(obj.contenu5==''){
h=h + ' poster="data/poster-ludivideo.jpg" ';
}else{
h=h + ' poster="' + obj.contenu5 + '" ';
}
var sty='';if(obj.cssadd){
sty=obj.cssadd;
}
...
var extenLgProcess='.php';function sendBilanMail(mynote,mkript,objm,history,srelai){
...
$('#bloc' + CObjets[i].id + ' .reponseholetext').each(function(index){
var ctr1=$(this).attr('data-rep');var idctr=$(this).attr('id');var ctr2=gei(idctr);if(Sit(ctr1)!=Sit(ctr2)){
var idAnim=CObjets[i].id * 100;$(this).before("<span id='idAnim" + idAnim + "' class='suiviErreurMark errorMark' >&#x2717;</span>");
}
});
}
